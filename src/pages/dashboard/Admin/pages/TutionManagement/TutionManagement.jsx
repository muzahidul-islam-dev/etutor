...
const TuitionManagement = () => {
    ...
    const [tuitions, setTuitions] = useState([
        { id: "JOB-101", title: "Class 9 Math", postedBy: "Muzahidul Islam", date: "2 hrs ago", status: "Pending", details: "Need a tutor for Higher Math." },
        { id: "JOB-102", title: "HSC Physics", postedBy: "Rahim Ahmed", date: "5 hrs ago", status: "Approved", details: "English medium background preferred." },
        { id: "JOB-103", title: "Class 5 All Subjects", postedBy: "Karim", date: "1 day ago", status: "Rejected", details: "Spam post." },
    ]);
                            ...
                            {job.status === 'Pending' && (
                                <>
                                    <button 
                                        ...
                                        className="bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-md transition-all flex items-center gap-2"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className="bg-white border border-red-200 text-red-600 hover:bg-red-50 px-4 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2"
                                    >
